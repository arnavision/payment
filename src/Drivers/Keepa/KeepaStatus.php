...
class KeepaStatus
{
    ...
    public static function errorMessage(null|int|string $code, ?string $fallback = null): string
    {
        $messages = [
            ...
            111 => 'تراکنش یافت نشد.',
            112 => 'تنظیمات درگاه اعتباری مالک زیرساخت یافت نشد.',
            113 => 'تنظیمات درگاه اعتباری مالک زیرساخت انجام نشده است.',
        ...
        return $messages[$key] ?? $fallback ?? 'خطای نامشخص کیپا.';
    }
}
